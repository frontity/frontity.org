...
interface FrontityOrg extends Package {
  ...
  actions: {
    theme: {
      ...
      showHeroTerminal: Action<FrontityOrg>;
      hideHeroTerminal: Action<FrontityOrg>;
      showHeroBlog: Action<FrontityOrg>;
      hideHeroBlog: Action<FrontityOrg>;
    };
  };
  libraries: {
    html2react?: {
